...
export default {
  name: 'speed',
  description: 'Установка фильтра скорости. / Installing a speed filter.',
  userPrams: [],
    ...
    if (input === 'off') {
      ...
      return await interaction.editReply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(i18next.t(`fspeedoff`, { emojiequalizer: `${emojiequalizer}`})),
        ],
      });
    } else if (input === 'on') {
      ...
      return await interaction.editReply({
        embeds: [
          new EmbedBuilder()
            .setColor(client.embedColor)
            .setDescription(i18next.t(`fspeedon`, { emojiequalizer: `${emojiequalizer}`})),
        ],
      });
    }
  },
