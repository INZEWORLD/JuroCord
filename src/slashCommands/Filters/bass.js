...
export default {
  name: 'bass',
  description: 'Устанавливает басовый фильтр. / Sets the bass filter.',
  userPrams: [],
    ...
    if (input === 'off') {
      ...
      return await interaction.editReply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(i18next.t(`fbassoff`, { emojiequalizer: `${emojiequalizer}`})),
        ],
      });
    } else if (input === 'on') {
      ...
      return await interaction.editReply({
        embeds: [
          new EmbedBuilder()
            .setColor(client.embedColor)
            .setDescription(i18next.t(`fbasson`, { emojiequalizer: `${emojiequalizer}`})),
        ],
      });
    }
  },
