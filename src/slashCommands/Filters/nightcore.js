...
export default {
  name: 'nightcore',
  description: 'Установка фильтра NightCore. / Installing the NightCore filter.',
  userPrams: [],
    ...
    if (input === 'off') {
      ...
      return await interaction.editReply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(i18next.t(`fnightcoreoff`, { emojiequalizer: `${emojiequalizer}`})),
        ],
      });
    } else if (input === 'on') {
      ...
      return await interaction.editReply({
        embeds: [
          new EmbedBuilder()
            .setColor(client.embedColor)
            .setDescription(i18next.t(`fnightcoreon`, { emojiequalizer: `${emojiequalizer}`})),
        ],
      });
    }
  },
