...
export default {
  name: 'earrape',
  description: 'Установка фильтра EarRape. / Installing an EarRape filter.',
  userPrams: [],
    ...
    if (input === off) {
      ...
      return await interaction.editReply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(i18next.t(`fearrapeoff`, { emojiequalizer: `${emojiequalizer}`})),
      ...
      return await interaction.editReply({
        embeds: [
          new EmbedBuilder()
            .setColor(client.embedColor)
            .setDescription(i18next.t(`fearrapeon`, { emojiequalizer: `${emojiequalizer}`})),
