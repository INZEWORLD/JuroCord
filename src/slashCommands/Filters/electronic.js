...
export default {
  name: 'electronic',
  description: 'Installing an electronic filter. / Installing an electronic filter.',
  userPrams: [],
    ...
    if (input === 'off') {
      ...
      return await interaction.editReply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(i18next.t(`felectronicoff`, { emojiequalizer: `${emojiequalizer}`})),
        ],
      });
    } else if (input === 'on') {
      ...
      return await interaction.editReply({
        embeds: [
          new EmbedBuilder()
            .setColor(client.embedColor)
            .setDescription(i18next.t(`felectronicon`, { emojiequalizer: `${emojiequalizer}`})),
        ],
      });
    }
  },
