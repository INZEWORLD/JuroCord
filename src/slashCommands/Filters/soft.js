...
export default {
  name: 'soft',
  description: 'Установка мягкого фильтра. / Installing a soft filter.',
  userPrams: [],
    ...
    if (input === 'off') {
      ...
      return await interaction.editReply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(i18next.t(`fsoftoff`, { emojiequalizer: `${emojiequalizer}`})),
        ],
      });
    } else if (input === 'on') {
      ...
      return await interaction.editReply({
        embeds: [
          new EmbedBuilder()
            .setColor(client.embedColor)
            .setDescription(i18next.t(`fsofton`, { emojiequalizer: `${emojiequalizer}`})),
        ],
      });
    }
  },
